 ...
 */
final class Version20210624153951 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE card_product (id INT AUTO_INCREMENT NOT NULL, product_id INT DEFAULT NULL, cart_id INT DEFAULT NULL, quantity INT NOT NULL, INDEX IDX_84508EDB4584665A (product_id), INDEX IDX_84508EDB1AD5CDBF (cart_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('ALTER TABLE card_product ADD CONSTRAINT FK_84508EDB1AD5CDBF FOREIGN KEY (cart_id) REFERENCES cart (id)');
