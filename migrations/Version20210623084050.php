 ...
 */
final class Version20210623084050 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pet ADD image VARCHAR(64) DEFAULT NULL, DROP image_url');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pet ADD image_url VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, DROP image');
